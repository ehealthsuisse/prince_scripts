...
# 20180508: 20180508: Update file name accordingame scheme ehealth suisse website (by Johannes Gnägi, eHealth Suisse)
# 
# ********************************************************************************
...
# FRENCH
# This is for customizing this script for the given specification
Source="http://e-health-wiki.ch/index.php/Ehscda:CDA-CH_2017_(specification)/fr"
Destination=$d"_CDA-CH_fr.pdf"
