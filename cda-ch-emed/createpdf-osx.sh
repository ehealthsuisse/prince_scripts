...
Source="http://e-health-wiki.ch/index.php/Ehscda:CDA-CH-EMED_(specification)"
Destination="CDA-CH-EMED_de_V$d.pdf"
...
# FRENCH
# This is for customizing this script for the given specification
Source="http://e-health-wiki.ch/index.php/Ehscda:CDA-CH-EMED_(specification)/fr"
Destination="CDA-CH-EMED_fr_V$d.pdf"
