...
SET SourceDe=http://e-health-wiki.ch/index.php/Ehscda:CDA-CH-LRTP_(specification)
SET SourceFr=http://e-health-wiki.ch/index.php/Ehscda:CDA-CH-LRTP_(specification)/fr
SET DestinationDe=CDA-CH-LRTP_de_V%DT%.pdf 
SET DestinationFr=CDA-CH-LRTP_fr_V%DT%.pdf 
ECHO %DestinationDe%
ECHO %DestinationFr%
