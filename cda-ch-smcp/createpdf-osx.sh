...
#Source="http://e-health-wiki.ch/index.php/Ehscda:CDA-CH-SMCP_(specification)"
#Destination="CDA-CH-SMCP_de_V$d.pdf"
...
# FRENCH
# This is for customizing this script for the given specification
Source="http://e-health-wiki.ch/index.php/Ehscda:CDA-CH-SMCP_(specification)/fr"
Destination="CDA-CH-SMCP_fr_V$d.pdf"
