...
SET SourceDe=http://e-health-wiki.ch/index.php/Ehscda:CDA-CH-LREP_(specification)
SET SourceFr=http://e-health-wiki.ch/index.php/Ehscda:CDA-CH-LREP_(specification)/fr
SET DestinationDe=CDA-CH-LREP_de_V%DT%.pdf 
SET DestinationFr=CDA-CH-LREP_fr_V%DT%.pdf 
ECHO %DestinationDe%
ECHO %DestinationFr%
