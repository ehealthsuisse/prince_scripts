...
Source="http://e-health-wiki.ch/index.php/Ehscda:CDA-CH-RESP_(specification)"
Destination="CDA-CH-RESP_de_V$d.pdf"
...
# FRENCH
# This is for customizing this script for the given specification
Source="http://e-health-wiki.ch/index.php/Ehscda:CDA-CH-RESP_(specification)/fr"
Destination="CDA-CH-RESP_fr_V$d.pdf"
