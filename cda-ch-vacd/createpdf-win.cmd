...
SET SourceDe=http://e-health-wiki.ch/index.php/Ehscda:CDA-CH-VACD_(specification)
SET SourceFr=http://e-health-wiki.ch/index.php/Ehscda:CDA-CH-VACD_(specification)/fr
SET DestinationDe=CDA-CH-VACD_de_V%DT%.pdf 
SET DestinationFr=CDA-CH-VACD_fr_V%DT%.pdf 
ECHO %DestinationDe%
ECHO %DestinationFr%
